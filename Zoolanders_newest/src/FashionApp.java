...
public class FashionApp extends PApplet {
	...
	public void setup() {
		...
		a.setPath("..\\models\\shirt\\black_tshirt_nike.obj");
		a.setType("shirt");
		Button b = new Button(0, 150, 100, 100);
		b.setPath("..\\models\\shirt\\Polo_shirt_white.obj");
		b.setType("shirt");
		b.setScale(0.35f);
...
//		imageMode(CENTER);
		...
		if (handsTrackFlag) {
			...
			rect(640-handVec2D.x, handVec2D.y, 30, 30);
		}
